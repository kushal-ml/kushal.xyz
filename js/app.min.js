...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Ashu Jha"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Ashu Jha</td></tr>
					<tr><td>Profession</td><td>Developer</td></tr>
					<tr><td>Sex</td><td>Female</td></tr>
					<tr><td>Resume</td><td><a href="images/RESUME2024.pdf" download>Download Resume</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:ashujha4444@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="https://www.linkedin.com/in/ashu-j-97466a1b3/"><i class="fab fa-linkedin-in"></i></a>
              <a href="https://x.com/bitbyte24"><i class="fab fa-twitter"></i></a>
              <a href="https://github.com/ashuna-dev" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Ashu Jha Facial Recognition">
  ...
  },
  {
    ...
    html: `<div class="profile-image"><img src="${imagePath}/my-cat.jpg" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Nezuko Kamado</td></tr>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td>HOBBIES</td><td>Reading</td><td>Journaling</td><td>Sketching</a></td></tr>
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>Python</td></tr>
				<tr><td>TypeScript</td><td>SQL</td></tr>
			</tbody>
		</table>`,
  },
  {
